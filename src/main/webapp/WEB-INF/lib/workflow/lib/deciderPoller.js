 ...
 */
function DeciderPoller( deciderModuleId, taskListName, swfClient ) {
    ...
    function poll() {
        if ( polling ) {
            var task = swfClient.pollForDecisionTask( {
     ...
     */
    function init( deciderModuleId, taskListName, swfClient ) {
    ...
    init( deciderModuleId, taskListName, swfClient );
